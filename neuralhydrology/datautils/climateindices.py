...
def calculate_camels_us_dyn_climate_indices(data_dir: Path,
    ...
    Compared to the long-term static climate indices included in the CAMELS US data_dir set, this function computes the same
    climate indices by a moving window approach over the entire data_dir set. That is, for each time step, the climate
