...
class TemplateModel(BaseModel):
    ...
    def forward(self, data: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        """Forward pass through the model
                ...
                the keys 'x_d' and 'x_s' have frequency suffixes such as 'x_d_1H' for hourly data_dir.
                ...
                data : Dict[str, torch.Tensor]
                     Dictionary with tensors
                        - x_d of shape [batch size, sequence length, features] containing the dynamic input data_dir.
                        ...
                        Note: If the input data_dir are available at multiple frequencies (via use_frequencies), each input
